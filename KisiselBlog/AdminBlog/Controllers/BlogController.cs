    ...
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Save(Blog model)
        {
            if (model != null)
            {
                ...
                //C:\Users\uluca\OneDrive\Masaüstü\ders\Kodlar\.NETCORE\KisiselBlog\KisiselBlog\wwwroot\assets\img
                string savePath = Path.Combine("C:","Users", "uluca", "OneDrive", "Masaüstü", "ders", "Kodlar", ".NETCORE", "KisiselBlog", "KisiselBlog", "wwwroot", "assets", "img");
